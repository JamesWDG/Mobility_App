        ...
        <ScrollViewComp>
          <Container extraStyle={styles.mainContainerStyles(insets?.top)}>
            ...
            <Container extraStyle={styles.innerContainer}>
              ...
              <Title
                text={labels.enterYourRegisteredEmailToRecoverPassword}
                fontSize={16}
                fontWeight={300}
                otherStyles={{
                  marginTop: 12,
            ...
            <Container extraStyle={styles.signInContainer}>
                <Button
                  ...
                  onPress={()=> {
                    if(Utility.validateEmail(isState?.email)){
                        navigation.navigate("verifyOTP" , {params :{type :  "forgot"}})
                    }
                  }}
                  fWeight={700}
                />
